...
export const homepageFaqs: FaqItem[] = [
  {
    ...
    answer:
      "Afhankelijk van het pakket en de complexiteit is je website binnen 7 dagen live. We houden je gedurende het hele proces op de hoogte.",
  },
  {
    question: "Heb ik technische kennis nodig?",
    answer:
      "Nee, absoluut niet. Wij regelen alles: van design tot hosting. Jij hoeft alleen content aan te leveren en feedback te geven.",
  },
  {
    question: "Zijn er verborgen kosten?",
    answer:
      "Nee, al onze pakketten zijn all-inclusive. Hosting, SSL-certificaat, onderhoud en support zitten allemaal in de prijs. Geen verrassingen achteraf.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Ja. Veel klanten starten met een website en breiden later uit met review management, boekingen of koppelingen. We bouwen je platform zo op dat je eenvoudig kunt groeien wanneer je er klaar voor bent.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "In veel gevallen wel. We koppelen onder andere met agenda's, e-mail, WhatsApp en andere tools via koppelingen. Staat jouw tool er niet tussen? Dan kijken we samen naar maatwerk.",
  },
];
...
export const contactFaqs: FaqItem[] = [
  {
    ...
    answer:
      "Je kunt ons bellen op +31 (0)6 12 34 56 78 (maandag t/m vrijdag, 09:00 tot 17:00), mailen naar info@nexavo.works of support@nexavo.works, of het contactformulier op deze pagina gebruiken. Bestaande klanten kunnen ook inloggen op het klantportaal.",
  },
  {
